...
<body>
    <form id="form1" runat="server">
        ...
        <dxpc:ASPxPopupControl ID="ppcLogin" runat="server" HeaderText="NetCardWeb ::  Seja bem vindo !"
            Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter"
            ClientInstanceName="ppcLogin" ShowOnPageLoad="True" ShowCloseButton="False" CloseAction="None">
            <ClientSideEvents Init="function(s, e) {edtLogin.Focus();}" />
            <ContentCollection>
                <dxpc:PopupControlContentControl runat="server">
                    <table align="center" class="style1">
                        ...
                        <tr>
                            <td>
                                <dxe:ASPxImage ID="ASPxImage3" runat="server" ImageUrl="~/Images/Medium/Cadeado.gif">
                                </dxe:ASPxImage>
                            </td>
                            <td>
                                <table>
                    ...
                    <table width="100%">
                        <tr>
                            <td style="text-align: center">
                                <asp:Button ID="SubmitButton" Text="Entrar" runat="server" OnClick="SubmitButton_Click"
    ...
    <script type="text/javascript">
        ...
        function ExcluirTelaFirefox() {
            ...
            if (z != null) z.style.backgroundColor = "#777777";
