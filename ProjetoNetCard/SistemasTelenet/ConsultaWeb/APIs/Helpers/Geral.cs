...
namespace NetCardConsulta.APIs.Helpers
{
    public static class Geral
    {
        public static TValue GetPropertyValue<TObject, TValue>(this TObject instance, string propertyName)
        {
            var property = typeof(TObject).GetProperty(propertyName);
            return property == null ? default(TValue) : (TValue)property.GetValue(instance);
        }
