...
using PagNet.Bld.PGTO.Itau.Application;
using PagNet.Bld.PGTO.Itau.Web.Setup.ContextNegocio;
using Telenet.Bld.ControleAcesso.Web.Setup;
using Telenet.BusinessLogicModel;
using Telenet.BusinessLogicModel.Abstractions;

namespace PagNet.Bld.PGTO.Itau.Web.Setup
{
    public class Startup : ControleAcessoClientStartupBase
    {
        ...
        {
            return "Telenet Services - Serviços de Transmissao PGTO Banco Itau  1.0.0";
        }
        ...
        protected override void OnConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddSingleton<IMessageTable>(s => new XmlFileDomainMessageTable("TransmissaoItau", "MessageTable.xml"))
