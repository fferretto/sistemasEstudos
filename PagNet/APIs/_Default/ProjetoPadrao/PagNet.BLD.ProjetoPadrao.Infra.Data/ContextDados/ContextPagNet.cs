...
using PagNet.BLD.ProjetoPadrao.Abstraction;
...
using System.Linq;
using PagNet.BLD.ProjetoPadrao.Infra.Data.EntityConfig;
...
namespace PagNet.BLD.ProjetoPadrao.Infra.Data.ContextDados
{
    ...
    public class ContextPagNet : DbContext
    {
        ...
        public DbSet<PAGNET_PARAM_ARQUIVO_CONCILIACAO> PAGNET_PARAM_ARQUIVO_CONCILIACAO { get; set; }
        public DbSet<PAGNET_ARQUIVO_CONCILIACAO> PAGNET_ARQUIVO_CONCILIACAO { get; set; }
        public DbSet<PAGNET_FORMA_VERIFICACAO_ARQUIVO> PAGNET_FORMA_VERIFICACAO_ARQUIVO { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new PagNet_Param_Arquivo_ConciliacaoMap());
            modelBuilder.ApplyConfiguration(new PagNet_Arquivo_ConciliacaoMap());
            modelBuilder.ApplyConfiguration(new PagNet_Forma_Verificacao_ArquivoMap());
