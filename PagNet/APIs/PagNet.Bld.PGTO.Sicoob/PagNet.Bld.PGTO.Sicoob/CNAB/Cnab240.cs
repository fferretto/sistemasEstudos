...
using PagNet.Bld.PGTO.Sicoob.ModelAuxiliar;
using PagNet.Bld.PGTO.Sicoob.Util;
using System;
using System.Collections.Generic;
using System.Text;

namespace PagNet.Bld.PGTO.Sicoob.CNAB
{
    public class CnabBradesco240
    {
        ...
        public string HeaderArquivo(mdCedente Cedente)
        {
            try
            {
                ...
                str += Helper.FormataInteiro("756", 3); //Código do Banco na Compensação 
                ...
                str += Helper.FormataTexto("SICOOB", 30); //Nome do Banco
        ...
        public string TrailerArquivo(int TotaLote, int TotalReg, int qtContas)
        {
            ...
            {
                string str = ValorVazio;
                str += Helper.FormataInteiro("756", 3); //Código do Banco 
