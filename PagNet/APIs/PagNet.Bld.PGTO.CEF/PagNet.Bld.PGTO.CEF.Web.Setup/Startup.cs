...
using PagNet.Bld.PGTO.CEF.Application;
using PagNet.Bld.PGTO.CEF.Web.Setup.ContextNegocio;
using Telenet.Bld.ControleAcesso.Web.Setup;
using Telenet.BusinessLogicModel;
using Telenet.BusinessLogicModel.Abstractions;

namespace PagNet.Bld.PGTO.CEF.Web.Setup
{
    public class Startup : ControleAcessoClientStartupBase
    {
        ...
        {
            return "Telenet Services - Serviços de Emissao e Transmissão de Arquivo de Remessa 1.0.0";
        }
        ...
        protected override void OnConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddSingleton<IMessageTable>(s => new XmlFileDomainMessageTable("TransmissaoCEF", "MessageTable.xml"))
