...
using PagNet.Bld.PGTO.CobrancaBancaria.Application;
using PagNet.Bld.PGTO.CobrancaBancaria.Web.Setup.ContextNegocio;
using Telenet.Bld.ControleAcesso.Web.Setup;
using Telenet.BusinessLogicModel;
using Telenet.BusinessLogicModel.Abstractions;

namespace PagNet.Bld.PGTO.CobrancaBancaria.Web.Setup
{
    public class Startup : ControleAcessoClientStartupBase
    {
        ...
        {
            return "Telenet Services - Serviços de Transmissao de registro de Cobranca Bancaria  1.0.0";
        }

        protected override string GetHostName()
        {
            return "APICobrancaBancaria";
        }
        ...
        protected override void OnConfigureServices(IServiceCollection services)
        {
            ...
            services
                ...
                .AddScoped<ICobrancaBancariaApp, CobrancaBancariaApp>()
        ...
        services
                ...
                .AddScoped<IPROC_PAGNET_LIBERA_DESCONTOFOLHARepository, PROC_PAGNET_LIBERA_DESCONTOFOLHARepository>()
            ...
            services
                .AddSingleton<IMessageTable>(s => new XmlFileDomainMessageTable("CobrancaBancaria", "MessageTable.xml"))
