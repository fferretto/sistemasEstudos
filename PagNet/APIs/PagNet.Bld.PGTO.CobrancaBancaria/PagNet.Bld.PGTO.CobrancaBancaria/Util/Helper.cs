...
namespace PagNet.Bld.PGTO.CobrancaBancaria.Util
{
    public static class Helper
    {
        ...
        public static string GeraNossoNumero(string NossoNumero, int codTitulo, string codigoBanco)
        {
            try
            {
                ...
                if (NossoNumero == "0" || NossoNumero == "")
                {
                    ...
                    if (codigoBanco == "748")
                    {
                        NossoNumero = RemoveCaracterDireita(NossoNumero, 5);
                    }
                    else
                    {
        ...
        {
            string valor = text.Replace("/", "").Replace("\\", "");
        ...
        public static string OcorrenciaBoletoCnab240(string codigo)
        {
            switch (codigo)
            {
                ...
                case "26":
                    return "RECUSADO"; //"Instrução Rejeitada";
                case "27":
                ...
                case "39":
                    return "RECUSADO"; //"Manutenção de Pagador Rejeitada";
                case "40":
                    return "Entrada de Título via Banco de Pagador Rejeitada";
                case "41":
                    return "RECUSADO"; //"Manutenção de Banco de Pagador Rejeitada";
                case "44":
