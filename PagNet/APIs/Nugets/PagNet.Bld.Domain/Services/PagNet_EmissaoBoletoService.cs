...
namespace PagNet.Bld.Domain.Services
{
    public class PAGNET_EMISSAOBOLETOService : ServiceBase<PAGNET_EMISSAOBOLETO>, IPAGNET_EMISSAOBOLETOService
    {
        ...
        {
            var Boletos = BuscaTodosFaturamentoByCodBordero(codBordero);
        ...
        public List<PAGNET_EMISSAOBOLETO> BuscaBoletoByCodCliente(int CodCliente)
        {
        ...
        public PAGNET_EMISSAOBOLETO BuscaBoletoByID(int id)
        {
            try
            {
        ...
        public PAGNET_EMISSAOBOLETO BuscaBoletoByNossoNumero(string NossoNumero)
        {
        ...
        public PAGNET_EMISSAOBOLETO BuscaBoletoBySeuNumero(string seuNumero)
        {
            try
            {
        ...
        public List<PAGNET_EMISSAOFATURAMENTO_LOG> BuscaLog(int codEmissaoFaturamento)
        {
            var boleto = _log.Get(x => x.CODEMISSAOFATURAMENTO == codEmissaoFaturamento, "PAGNET_USUARIO").ToList();
        ...
        {
            int numBol = _rep.BuscaProximoID();
        ...
        {
            int numBol = _repFaturamento.BuscaProximoID();

            return numBol;
        }
        public List<PAGNET_EMISSAOBOLETO> BuscaTodosBoletoByCodArquivo(int CodArquivo)
        {
            var boleto = _rep.Get(x => x.CODARQUIVO == CodArquivo, "PAGNET_CADCLIENTE,PAGNET_CADEMPRESA").ToList();
            return boleto;
        }

        public List<PAGNET_EMISSAOBOLETO> BustaTodosBoletosParaEdicao(int codigoEmpresa)
        {
        ...
        public List<PAGNET_EMISSAOBOLETO> GetAllBoletos(string status, int codEmpresa, int codCli, DateTime dtInicio, DateTime dtFim)
        {
        ...
        public List<PAGNET_EMISSAOBOLETO> GetAllBoletosNaoVencidos(int codEmpresa, int codCli)
        {
        ...
        public List<PAGNET_EMISSAOBOLETO> GetBoletosRegistradosNaoLiquidados(int codEmpresa, int CodContaCorrente, int codCli, DateTime dtInicio, DateTime dtFim)
        {
        ...
        public void IncluiLog(PAGNET_EMISSAOFATURAMENTO faturamento, int codUsuario, string Justificativa)
        {
            try
            {
                ...
                int numBol_log = _log.BuscaProximoID();
        ...
        {
            var ListaTitulos = BuscaTodosFaturamentoByCodBordero(codBordero);
            PAGNET_EMISSAOFATURAMENTO_LOG LOG = new PAGNET_EMISSAOFATURAMENTO_LOG();
            LOG = null;
        ...
        public List<PAGNET_EMISSAOBOLETO> BustaTodosBoletosVencidos()
        {
        ...
        public PAGNET_EMISSAOFATURAMENTO BuscaFaturamentoByID(int id)
        {
            try
            {
        ...
        public List<PAGNET_EMISSAOFATURAMENTO> BuscaTodosFaturamentoByCodBordero(int CodBordero)
        {
            var faturamento = _repFaturamento.Get(x => x.CODBORDERO == CodBordero, "PAGNET_CADCLIENTE,PAGNET_CADEMPRESA").ToList();
            return faturamento;
        }

        public List<PAGNET_EMISSAOFATURAMENTO> BustaTodosFaturamentosParaEdicao(int codigoEmpresa)
        {
        ...
        public List<PAGNET_EMISSAOFATURAMENTO> BuscaFaturamentoBySeuNumero(string seuNumero)
        {
            try
            {
        ...
        public List<PAGNET_EMISSAOFATURAMENTO> BuscaFaturamentoByCodCliente(int CodCliente)
        {
            try
            {
        ...
        {
            var ListaTitulos = BuscaFaturamentoBySeuNumero(seuNumero);
            PAGNET_EMISSAOFATURAMENTO_LOG LOG = new PAGNET_EMISSAOFATURAMENTO_LOG();
            LOG = null;
        ...
        public List<PAGNET_EMISSAOFATURAMENTO> GetAllFaturas(string status, int codEmpresa, int codCli, DateTime dtInicio, DateTime dtFim)
        {
            status = (status == "TODOS") ? "" : status;
        ...
        public PAGNET_EMISSAOFATURAMENTO BuscaFaturamentoByNroDocumento(string nroDocumento)
        {
            try
            {
        ...
        public List<PAGNET_EMISSAOFATURAMENTO> ListaFaturamentoNaoLiquidado(int codEmpresa)
        {
            try
            {
                DateTime dataAtual = Convert.ToDateTime(DateTime.Now.ToShortDateString());
        ...
        public List<PAGNET_EMISSAOFATURAMENTO> BuscaTransacaoAConsolidar(int codigoEmpresa, int codContaCorrente, int mes, int ano)
        {
        ...
        public int RetornaquantidadeParcelasFuturas(int codigo)
        {
            try
            {
        ...
        public List<PAGNET_EMISSAOFATURAMENTO> BuscaFaturamentoByIDPai(int codigoPai, int Codigo)
        {
            if (codigoPai > 0)
            {
        ...
        public List<PAGNET_EMISSAOFATURAMENTO> BuscaFaturamentosByData(DateTime dtRealPGTO, int codContaCorrente)
        {
        ...
        public List<PAGNET_EMISSAOFATURAMENTO> BuscaFaturamentosNaoConciliados(int codigoEmpresa, int codContaCorrente, DateTime dataInicio, DateTime dataFim)
        {
            var listaTransacao = _repFaturamento.Get(x => x.CODEMPRESA == codigoEmpresa &&
                                    x.CODCONTACORRENTE == codContaCorrente &&
        ...
        {
            return _repFaturamento.Get(x => (x.STATUS == "A_FATURAR" || x.STATUS == "EM_ABERTO") &&
        ...
        public List<PAGNET_EMISSAOFATURAMENTO> BuscaFaturas(int codigoCliente, DateTime dataVencimento)
        {
            
            var fatura = _repFaturamento.Get(x => x.CODCLIENTE == codigoCliente &&
                                               x.DATVENCIMENTO == dataVencimento &&
                                               x.STATUS != "EM_ABERTO" &&
                                               x.STATUS != "RECUSADO").ToList();
