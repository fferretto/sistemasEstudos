...
namespace PagNet.Bld.Domain.Services.Procedures
{
    public class ProceduresService : ServiceBase<PAGNET_TITULOS_PAGOS>, IProceduresService
    {
        ...
        private readonly IMW_CONSCEPRepository _Endereco;
        ...
        private readonly IPROC_BAIXA_LOTE_CPFRepository _baixaLoteCPF;
        ...
        private readonly IPROC_PAGNET_LIBERA_DESCONTOFOLHARepository _liberaDF;
        private readonly IPROC_PAGNET_CONS_FATURAS_BORDERORepository _consulta_faturasBordero;
        ...
        public ProceduresService(IPAGNET_TITULOS_PAGOSRepository rep,
                                IPROC_BAIXA_LOTE_CPFRepository baixaLoteCPF,
                                ...
                                IMW_CONSCEPRepository Endereco,
                                IPROC_PAGNET_LIBERA_DESCONTOFOLHARepository liberaDF,
                                IPROC_PAGNET_CONS_FATURAS_BORDERORepository consulta_faturasBordero,
            ...
            : base(rep)
        {
            ...
            _baixaLoteCPF = baixaLoteCPF;
            _IncluiClienteUsuNC = IncluiClienteUsuNC;
            _liberaDF = liberaDF;
            _consulta_faturasBordero = consulta_faturasBordero;
        }
        ...
        {
            var dados = await _Endereco.ConsultaEndereco(CEP);
        ...
        public PROC_BAIXA_LOTE_CPF ExecutarProcedure(int codigoCliente, int Lote, string CPF, string ResultSet)
        {
            ...
            string MensOut;
            int CodRetOut;
            var dadosRet = _baixaLoteCPF.ExecutarProcedure(codigoCliente, Lote, CPF, ResultSet, out TetOut, out MensOut, out CodRetOut);
            return dadosRet;
        }

        public PROC_PAGNET_LIBERA_DESCONTOFOLHA ExecutarDescontoFolha(int codigoCliente, int codigoFatura, int nroLote, string listaCPF, int codUsuarioPN)
        {
            return _liberaDF.ExecutarDescontoFolha(codigoCliente, codigoFatura, nroLote, listaCPF, codUsuarioPN);
        }

        public List<PROC_PAGNET_CONS_FATURAS_BORDERO> ExecutarConsFaturaBordero(DateTime dtInicio, DateTime dtFim, int codCliente, int codEmpresa, int codContaCorrente)
        {
            return _consulta_faturasBordero.ExecutarConsFaturaBordero(dtInicio, dtFim, codCliente, codEmpresa, codContaCorrente);
