...
{
    public partial class PAGNET_USUARIO
    {
        public PAGNET_USUARIO()
        {
            ...
            this.PAGNET_CADFAVORECIDO_LOG = new List<PAGNET_CADFAVORECIDO_LOG>();
        }
        ...
        public virtual ICollection<PAGNET_CADFAVORECIDO_LOG> PAGNET_CADFAVORECIDO_LOG { get; set; }
