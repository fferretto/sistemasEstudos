...
namespace PagNet.Bld.Domain.Entities
{
    public partial class PAGNET_CADFAVORECIDO
    {
        public PAGNET_CADFAVORECIDO()
        {
            ...
            this.PAGNET_CADFAVORECIDO_CONFIG = new List<PAGNET_CADFAVORECIDO_CONFIG>();
        }
        ...
        public virtual ICollection<PAGNET_CADFAVORECIDO_CONFIG> PAGNET_CADFAVORECIDO_CONFIG { get; set; }        
