...
namespace PagNet.Bld.Domain.Entities
{
    public partial class OPERADORA
    {
        public OPERADORA()
        {
            PAGNET_USUARIO_CONCENTRADOR = new List<PAGNET_USUARIO_CONCENTRADOR>();
        }
        ...
        public virtual ICollection<PAGNET_USUARIO_CONCENTRADOR> PAGNET_USUARIO_CONCENTRADOR { get; set; }
    }
}
