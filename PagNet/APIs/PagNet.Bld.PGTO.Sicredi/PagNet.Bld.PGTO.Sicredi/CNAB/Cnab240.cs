...
using PagNet.Bld.PGTO.Sicredi.ModelAuxiliar;
using PagNet.Bld.PGTO.Sicredi.Util;
using System;
using System.Collections.Generic;
using System.Text;

namespace PagNet.Bld.PGTO.Sicredi.CNAB
{
    public class Cnab240
    {
        ...
        public string HeaderArquivo(mdCedente Cedente)
        {
            try
            {
                ...
                str += Helper.FormataInteiro("748", 3); //Código do Banco na Compensação 
                ...
                str += Helper.FormataTexto("SICREDI", 30); //Nome do Banco
                ...
                str += Helper.FormataInteiro("082", 3); //Número da Versão do Layout
        ...
        public string TrailerArquivo(int TotaLote, int TotalReg, int qtContas)
        {
            ...
            {
                string str = ValorVazio;
                str += Helper.FormataInteiro("748", 3); //Código do Banco 
        ...
        public string HeaderLote(mdCedente Cedente, TransacaoTransferencia Transacoes, int NumLot)
        {
            try
            {
                ...
                str += Helper.FormataInteiro("042", 3); //Número da Versão do Lote
...
=======
                str += Helper.FormataTexto(ValorVazio, 2); //Código Finalidade Complementar
>>>>>>> remotes/origin/master
        ...
        public string DetalheLoteSegmento_B(mdCedente Cedente, TransacaoTransferencia trans, int NumLot, int NumSeq)
        {
            try
            {
                ...
                str += Helper.FormataInteiro(ValorVazio, 3); //Complemento CEP do Favorecido
...
=======
                str += Helper.FormataTexto(ValorVazio, 8); //Código ISPB
>>>>>>> remotes/origin/master
        ...
        public string DetalheLoteSegmento_J(mdCedente Cedente, TransacoesPagamento Trans, int NumLot, int NumSeq)
        {
            try
            {
                ...
                str += Helper.FormataInteiro("09", 2); //Código da Moeda
