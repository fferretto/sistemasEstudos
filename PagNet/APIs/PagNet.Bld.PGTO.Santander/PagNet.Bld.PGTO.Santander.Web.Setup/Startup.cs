...
using PagNet.Bld.PGTO.Santander.Application;
using PagNet.Bld.PGTO.Santander.Web.Setup.ContextNegocio;
...
namespace PagNet.Bld.PGTO.Santander.Web.Setup
{
    public class Startup : ControleAcessoClientStartupBase
    {
        ...
        {
            return "Telenet Services - Serviços de Transmissao PGTO Banco Santander  1.0.0";
        }

        protected override string GetHostName()
        {
            return "APIPGTOSantander";
        }
        ...
        protected override void OnConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddSingleton<IMessageTable>(s => new XmlFileDomainMessageTable("TransmissaoSantander", "MessageTable.xml"))
