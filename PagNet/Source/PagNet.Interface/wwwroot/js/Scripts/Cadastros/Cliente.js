...
function carregaPagina() {
    ...
    if ($('#COBRANCADIFERENCIADA').val() == "True") {
        ...
        if ($('#AgruparFaturamentos').val() == "True") {
...
$("#btnAgruparCobrancaNao").click(function () {
    $("#AgruparFaturamentos").val('false');
})

$("#btnAgruparCobrancaSim").click(function () {
    $("#AgruparFaturamentos").val('true');
})
...
function JustificativaDesativarCliente() {
    ...
    var url = montaUrl("/Cadastros/Cliente/Justificativa")
...
function ConfirmaSalvar() {
    ...
    if (Valido) {
        ...
        var url = montaUrl("/Cadastros/Cliente/Salvar/");
...
function JustificativaDesativarCliente() {
    ...
    var url = montaUrl("/Cadastros/Cliente/DesativaCliente");
...
function LocalizaCliente() {
    ...
    var url = montaUrl("/Cadastros/Cliente/ConsultaCliente");
