...
namespace PagNet.Interface.Areas.Cadastros.Controllers
{
    [Area("Cadastros")]
    [Authorize]
    public class ClienteUsuarioController : ClientSessionControllerBase
    {
        private readonly IAPIClienteAPP _APICliente;
        private readonly IPagNetUser _user;

        public ClienteUsuarioController(IAPIClienteAPP APICliente,
                                        IPagNetUser user)
        {
        ...
        public async Task<ActionResult> ConsultaCliente(int? codEmpresa)
        {
            try
            {
                ...
                var dados = await _APICliente.ConsultaTodosCliente((int)codEmpresa, "F");
            ...
            var lista = new object[][]
             {
                ...
                new object[] { "USUARIOCANCELADONETCARD", "USUÁRIO FOI CANCELADO NO SISTEMA NETCARD"},
