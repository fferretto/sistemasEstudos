...
{
    public class ProcessaDadosSantander : IProcessaDadosSantander
    {
        ...
        public ProcessaDadosSantander(IPagNet_OcorrenciaRetPagService ocorrencia,
        ...
        public async Task<string> GeraArquivoSantander(BorderoPagVM model, int codArquivo)
        {
            try
            {
                string nmArquivo;
        ...
        public void GerarArquivoRemessa(int codArquivo, BorderoPagVM model, mdCedente cedente, string arquivo)
        {
            try
            {
                ...
                CnabSantander240 GA = new CnabSantander240();
